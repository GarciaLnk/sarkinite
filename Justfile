...
rechunk $image="sarkinite" $tag="stable" $flavor="main" ghcr="0" pipeline="0":
    ...
    LABELS="
        ...
        io.artifacthub.package.maintainers=[{\"name\": \"GarciaLnk\", \"email\": \"sarkinite@garcialnk.com\"}]
        ...
        org.opencontainers.image.source=https://raw.githubusercontent.com/GarciaLnk/sarkinite/refs/heads/main/Containerfile
        org.opencontainers.image.title=${image_name}
        org.opencontainers.image.url=https://github.com/GarciaLnk/sarkinite
...
build-iso $image="sarkinite" $tag="stable" $flavor="main" ghcr="0" pipeline="0":
    ...
    iso_build_args+=(ENROLLMENT_PASSWORD="sarkinite")
