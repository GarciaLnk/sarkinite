...
COMMIT_FORMAT = "\n| **[{short}](https://github.com/GarciaLnk/sarkinite/commit/{githash})** | {subject} |"
...
```bash
sudo bootc switch ghcr.io/GarciaLnk/sarkinite:{target} --enforce-container-sigpolicy
```
#### For this specific image:
```bash
sudo bootc switch ghcr.io/GarciaLnk/sarkinite:{curr} --enforce-container-sigpolicy
```
"""
